...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  sudo rm -rf build/common && git clone -b main --depth 1 https://github.com/asxs123/common build/common
...
git clone -b main --depth 1 https://github.com/asxs123/build-actions shangyou
...
curl -fsSL https://raw.githubusercontent.com/asxs123/common/main/common.sh -o common.sh
if [[ $? -ne 0 ]]; then
  wget -q https://raw.githubusercontent.com/asxs123/common/main/common.sh -O common.sh
fi
...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  export GIT_REPOSITORY="asxs123/build-actions"
  sudo rm -rf build common.sh
